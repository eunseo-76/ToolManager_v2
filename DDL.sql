...
(
	...
	, PHONE2	VARCHAR(13) NOT NULL COMMENT '연락처2'
	, EMAIL_ADDR	VARCHAR(255) COMMENT '이메일'
	, WEBSITE	VARCHAR(255) COMMENT '웹사이트'
	, PAY_DT	VARCHAR(255) COMMENT '결제일'
	, DEL_YN	BOOLEAN DEFAULT 0 COMMENT '삭제여부'
	, DEL_DT	DATETIME NOT NULL COMMENT '삭제일'
	, CUST_DEL_USR INT COMMENT '삭제한 사용자'
);
...
(
	...
	, MODEL_NO	VARCHAR(255) NOT NULL COMMENT '모델넘버'
